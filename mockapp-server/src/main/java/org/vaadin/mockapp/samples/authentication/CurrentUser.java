...
/**
 * Class for retrieving and setting the name of the current user of the current session (without using JAAS).
 * All methods of this class require that a {@link VaadinRequest} is bound to the current thread.
 *
